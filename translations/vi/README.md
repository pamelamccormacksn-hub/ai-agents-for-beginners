...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T10:41:29+00:00",
  "source_file": "README.md",
  "language_code": "vi"
}
-->
# Khóa học về AI Agents dành cho người mới bắt đầu
...
## Một khóa học dạy bạn mọi thứ cần biết để bắt đầu xây dựng AI Agents
...
Mỗi bài học trong khóa học này đều bao gồm các ví dụ mã, có thể tìm thấy trong thư mục code_samples. Bạn có thể [fork repo này](https://github.com/microsoft/ai-agents-for-beginners/fork) để tạo bản sao của riêng mình.  
...
- [Github Models](https://aka.ms/ai-agents-beginners/github-models) - Miễn phí / Hạn chế
...
Để biết thêm thông tin về cách chạy mã cho khóa học này, hãy truy cập [Cài đặt khóa học](./00-course-setup/README.md).
...
Thỏa thuận Giấy phép Người đóng góp (CLA) xác nhận rằng bạn có quyền và thực sự cấp cho chúng tôi
