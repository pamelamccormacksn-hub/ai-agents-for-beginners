...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-15T08:29:04+00:00",
...
- Примечание: Если вы предпочитаете открыть репозиторий напрямую в Codespaces (без дополнительного клонирования), учтите, что Codespaces создаст окружение devcontainer и может всё равно загрузить больше, чем вам нужно. Клонирование поверхностной копии внутри нового Codespace даёт вам больше контроля над использованием диска.

#### Советы

- Всегда заменяйте URL клонирования на ваш форк, если вы хотите редактировать/коммитить.
- Если позже вам понадобится больше истории или файлов, вы можете их получить или настроить выборочную проверку для включения дополнительных папок.
...
4. Ограничьте разрешения токена: В разделе **Permissions** нажмите вкладку **Account** и нажмите кнопку "+ Add permissions". Появится выпадающее меню. Найдите **Models** и установите галочку для него.
...
6. Перед созданием токена убедитесь, что вы готовы сохранить токен в безопасном месте, например, в хранилище паролей, так как он не будет показан снова после создания. ![Store Token Securely](../../../translated_images/store_token_securely.08ee2274c6ad6caf3482f1cd1bad7ca3fdca1ce737bc485bfa6499c84297c789.ru.png)
...
- `AZURE_AI_PROJECT_NAME` - Посмотрите наверху страницы **Overview** вашего проекта.
