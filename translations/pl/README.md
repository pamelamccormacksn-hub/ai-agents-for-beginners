...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T10:33:34+00:00",
...
Ten kurs zawiera lekcje obejmujące podstawy budowania AI Agentów. Każda lekcja dotyczy osobnego tematu, więc możesz zacząć od dowolnego miejsca!
...
| Tworzenie agentów do obsługi komputerów (CUA)        | Wkrótce dostępne                            |                                                            |                                                                                        |
...
Contributor License Agreement (CLA), który potwierdza, że masz prawo i faktycznie udzielasz nam
...
Ten projekt może zawierać znaki towarowe lub logotypy projektów, produktów lub usług. Autoryzowane użycie znaków towarowych Microsoft
lub logotypów podlega i musi być zgodne z
