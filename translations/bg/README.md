...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T10:47:56+00:00",
...
Не забравяйте да [добавите звезда (🌟) към този репозитори](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) и [разклонете този репозитори](https://github.com/microsoft/ai-agents-for-beginners/fork), за да изпълните кода.

### Срещнете други обучаващи се, задайте въпроси
...
Всеки урок в този курс включва примери за код, които можете да намерите в папката code_samples. Можете да [разклоните този репозитори](https://github.com/microsoft/ai-agents-for-beginners/fork), за да създадете свое копие.  
...
| Използване на агентни протоколи (MCP, A2A и NLWeb) | [Линк](./11-agentic-protocols/README.md)           | [Видео](https://youtu.be/X-Dh9R3Opn8)                                 | [Линк](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Инженеринг на контекст за AI агенти                | [Линк](./12-context-engineering/README.md)         | [Видео](https://youtu.be/F5zqRV7gEag)                                 | [Линк](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Управление на агентна памет                        | [Линк](./13-agent-memory/README.md)     |      [Видео](https://youtu.be/QrYbHesIxpw?si=vZkVwKrQ4ieCcIPx)                                                      |                                                                                        |
| Изследване на Microsoft Agent Framework           | [Линк](./14-microsoft-agent-framework/README.md)                            |                                                            |                                                                                        |
...
Благодарности на [Шивам Гоял](https://www.linkedin.com/in/shivam2003/) за предоставянето на важни примерни кодове, демонстриращи Agentic RAG. 
