...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T10:19:51+00:00",
...
Если вы впервые работаете с генеративными AI-моделями, рекомендуем пройти наш курс [Generative AI For Beginners](https://aka.ms/genai-beginners), который включает 21 урок по работе с GenAI.

Не забудьте [поставить звезду (🌟) этому репозиторию](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) и [форкнуть его](https://github.com/microsoft/ai-agents-for-beginners/fork), чтобы запустить код.

### Общайтесь с другими учениками и задавайте вопросы
...
| Паттерн проектирования мульти-агентов        | [Ссылка](./08-multi-agent/README.md)             | [Видео](https://youtu.be/V6HpE9hZEx0?si=rMgDhEu7wXo2uo6g)  | [Ссылка](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
